...
function StartScreen({ onStart, language, onLanguageChange, totalCoins, unlockedAvatars, activeAvatars, onBuyAvatar, unlockedTopics, onBuyTopic, unlockedSkins, activeSkins, onBuySkin, onToggleAvatar, onToggleSkin, unlockedThemes, activeTheme, onBuyTheme, onEquipTheme }) {
    ...
    return (
        <div className="start-screen glass-panel">
            ...
            <div className="start-screen-main-layout">
                <div className="layout-col-left">
                    <div className="config-section">
                        <h3>{language === 'he' ? '1. בחרו מצב משחק' : '1. Choose Game Mode'}</h3>
                    ...
                    <div className="config-section">
                        <div className="section-header-with-btn">
                            <h3>{language === 'he' ? '2. בחרו אווטאר' : '2. Choose Avatar'}</h3>
                        </div>
                        <div className={`avatar-selection-container card-pop ${gameMode === '1v1' || gameMode === 'tictactoe' ? 'multi-player' : ''}`}>
                    ...
                    {gameMode !== 'survival' && gameMode !== 'endless' && (
                        <div className="mode-params-container">
                            <div className="config-section">
                                ...
                                <div className="diff-options" style={{ marginTop: '0.8rem' }}>
