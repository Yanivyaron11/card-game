export const translations = {
    en: {
        ...
        rule_endless_1: "Avalanche Mode (5x5): A rising tide of stones 🔒 fills the board one-by-one every 5 seconds (Stage 1). If any column reaches the top (5 stones), it's game over! Survive by clearing cards and reach new stages for massive coin bonuses.",
    ...
    he: {
        ...
        rule_endless_1: "מפולת (5x5): גאות של אבנים 🔒 הממלאות את הלוח אחת-אחת כל 5 שניות (בשלב הראשון). אם טור אחד מתמלא עד למעלה (5 אבנים) - המשחק נגמר! שרדו על ידי פתרון שאלות וניקוי הלוח וקבלו בונוסים ענקיים במעברי שלבים.",
