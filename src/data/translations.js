export const translations = {
    en: {
        ...
        choose_size: "3. Choose Board Size",
        choose_difficulty: "3. Choose Difficulty",
        choose_topics: "4. Choose Topics",
        level: "Level",
        hearts: "Hearts",
        coins: "Coins",
        game_over: "Game Over!",
        ...
        rules_section_mechanics: "Special Mechanics",
        ...
        rule_endless_1: "Avalanche Mode (5x5): A rising tide of stones 🔒 fills the board. Stones drop every 4/3/2 seconds into random columns based on your progress. If any column reaches the top (5 stones), it's game over! Note: Gravity continues while answering questions—think fast!",
        rule_endless_2: "Avalanche Row/Col Bomb: Blast away a full line of cards to survive the avalanche!",
        rule_endless_3: "Avalanche Cross Bomb: Clear a massive cross-zone of cards to give yourself breathing room!",
        rule_endless_4: "Avalanche Stage 2: Reaching 10 correct answers spawns the Gladiator boss and grants an instant 50 coin bonus!",
        rule_endless_5: "Avalanche Boss Stage: Reaching 20 correct answers spawns the Volcano boss and grants a massive 100 coin bonus!",
        rule_endless_6: "Avalanche Champion: Beating 30 questions grants a legendary 200 coin bonus!",
        ...
        rule_thief: "Thief (Tic-Tac-Toe): Usable once per game, only if opponent has a claimed square. Steal & reset an opponent's square, costing your turn.",
        rule_shield: "Shield (Tic-Tac-Toe): Usable once per game, protect one of your squares from the Thief permanently. Free action.",
        ...
        rule_hearts: "Lives: 3x3 (2) / 4x4 (3) / 5x5 (4)",
    ...
    he: {
        ...
        lets_play: "בואו נשחק!",
        choose_size: "3. בחרו את גודל הלוח",
        choose_difficulty: "3. בחרו רמת קושי",
        choose_topics: "4. בחרו נושאים",
        level: "רמה",
        hearts: "חיים",
        coins: "מטבעות",
        ...
        rules_section_mechanics: "מכניקות מיוחדות",
        rule_level_1: "תשובה נכונה (רמה 1): מטבע 1",
        rule_level_2: "תשובה נכונה (רמה 2): 2 מטבעות",
        rule_level_3: "תשובה נכונה (רמה 3): 3 מטבעות",
        rule_endless_1: "מפולת (5x5): גאות של אבנים 🔒 הממלאות את הלוח. אבנים נופלות כל 4/3/2 שניות בטורים אקראיים לפי קצב ההתקדמות שלכם. אם טור אחד מתמלא עד למעלה (5 אבנים) - המשחק נגמר! שימו לב: המפולת לא עוצרת כשעונים על שאלה - חשבו מהר!",
        rule_endless_2: "מפולת - פצצת שורה/עמודה: פוצצו המון קלפים בבת אחת כדי למנוע מהמפולת להגיע לתקרה!",
        rule_endless_3: "מפולת - פצצת צלב: פוצצו קלפים לכל הכיוונים ונקו שטח ענק שיעזור לכם לשרוד!",
        rule_endless_4: "מפולת דרגה 2: פתרון 10 שאלות מוביל לבוס הגלדיאטור ומעניק בונוס מיידי של 50 מטבעות!",
        rule_endless_5: "מפולת דרגה 3: פתרון 20 שאלות מוביל לבוס האבן ומעניק בונוס ענק של 100 מטבעות!",
        rule_endless_6: "אלוף המפולת: סיום מוצלח של 30 שאלות מנצח את המשחק ומעניק בונוס אדיר של 200 מטבעות!",
        ...
        rule_thief: "גנב (איקס-עיגול): אפשרי פעם במשחק, רק אם ליריב יש משבצת כבושה. חוטף ומאפס משבצת של היריב במקום התור שלך.",
        rule_shield: "מגן (איקס-עיגול): אפשרי פעם במשחק, רק אם יש לך משבצת. מגן על המשבצת שלך מפני גנב לנצח, ללא איבוד תור.",
        ...
        rule_hearts: "כמות חיים: לוח 3x3 (2) / 4x4 (3) / 5x5 (4)",
