export const translations = {
    en: {
        ...
        rule_endless_1: "Avalanche Mode (4x4): Correct answers grant coins based on difficulty (1/2/3). Massive coin payloads are exclusively earned by reaching new boss stages every 10 questions!",
    ...
    he: {
        ...
        rule_endless_1: "מפולת (4x4): ככל שתשרדו, תרוויחו מטבעות על כל תשובה (1/2/3). בונוסים מטורפים מתקבלים אך ורק במעברי שלבים (כל 10 שאלות) ובהבסת בוסים!",
