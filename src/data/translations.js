export const translations = {
    en: {
        ...
        rule_survival_completion: "Survival Completion: Junior +30 / Master +50 / Topic +15",
        rule_survival_focused: "Topic Track: Earn ½ coins compared to regular tracks (easier mode)",
        rule_board_completion: "Board Completion (Solo/Time Attack): 3x3 (+10), 4x4 (+20), 5x5 (+30)",
        rule_perfect_board: "Perfect Board (Solo/Time Attack): Double the Board Completion Bonus",
    ...
    he: {
        ...
        rule_survival_completion: "סיום מסלול הישרדות: ג'וניור +30 / מאסטר +50 / לפי נושא +15",
        rule_survival_focused: "מסלול נושא: זוכים ב-½ מטבעות לעומת המסלולים הרגילים (מצב קל יותר)",
        rule_board_completion: "סיום לוח (יחיד/נגד השעון): 3x3 (+10), 4x4 (+20), 5x5 (+30)",
        rule_perfect_board: "לוח מושלם (יחיד/נגד השעון): כפליים בונוס סיום הלוח",
