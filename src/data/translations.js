export const translations = {
    en: {
        ...
        rule_endless_1: "Avalanche Mode: Correct answers grant coins based on difficulty (1/2/3). Massive coin payloads are exclusively earned by reaching new boss stages!",
        ...
        rule_endless_4: "Avalanche Stage 2: Reaching the Gladiator boss grants an instant 50 coin bonus!",
        rule_endless_5: "Avalanche Boss Stage: Reaching the Volcano boss grants a massive 100 coin bonus!",
        rule_endless_6: "Avalanche Champion: Beating the Volcano boss grants a legendary 200 coin bonus!",
    ...
    he: {
        ...
        rule_endless_1: "מפולת (Endless): ככל שתשרדו, תרוויחו מטבעות על כל תשובה (1/2/3). בונוסים מטורפים של מטבעות מתקבלים אך ורק במעברי שלבים והבסת בוסים!",
        ...
        rule_endless_4: "מפולת דרגה 2: הגעה לבוס הגלדיאטור מעניקה בונוס מיידי של 50 מטבעות!",
        rule_endless_5: "מפולת דרגה 3: הגעה לבוס האבן מעניקה בונוס ענק של 100 מטבעות!",
        rule_endless_6: "אלוף המפולת: ניצחון על בוס האבן וסיום המשחק מעניק בונוס אדיר של 200 מטבעות!",
